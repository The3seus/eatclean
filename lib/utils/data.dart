...
class Data {
  static List<Recipe> recipes = [
    Recipe(
        ...
        imageUrl:
            'https://www.feastingathome.com/wp-content/uploads/2018/02/Frankie-Recipe-Indian-Burrito-100-3.jpg',
        nutrients: [
          Nutrients(name: 'Calories', weight: '490', percent: 0.49),
          Nutrients(name: 'Protein', weight: '14.2gm', percent: 0.14),
          Nutrients(name: 'Carb', weight: '20gm', percent: 0.2),
        ],
        steps: [
